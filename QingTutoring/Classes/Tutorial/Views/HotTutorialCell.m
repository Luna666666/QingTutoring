...
{
    ButtonWithTitle*_backTutoria;//返回按钮
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _backTutoria =  [[ButtonWithTitle alloc]initWithFrame:CGRectMake(10,20,10,20) andImageFrame:CGRectMake(0,0,10,20) andTitleFrame:CGRectZero];
        [_backTutoria setUIWithFont:[UIFont fontWithName:@"PingFang SC" size:12] andColor:[UIColor colorWithHex:@"#101010"] andTitle:@"17625902072" andImageName:@"home_back"];
        [self addSubview:_backTutoria];
...
//
//        _hotTutorial =  [[ButtonWithTitle alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_backTutoria.frame)+5,CGRectGetMaxY(_tutorialPic.frame)+5,80,30) andImageFrame:CGRectMake(0,5,12,15) andTitleFrame:CGRectMake(12,3,60,20)];
